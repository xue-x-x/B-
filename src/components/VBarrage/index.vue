  ...
  export default {
    ...
    methods: {
      ...
      init () {
        ...
        for (let j = 0; j < this.CHANNEL_COUNT; j++) {
          ...
          for (let i = 0; i < this.MAX_DM_COUNT; i++) {
            ...
            dom.style.top = j * (this.barrageMainDm.clientHeight / this.CHANNEL_COUNT) + 20 + 'px';
      ...
      shootDanmu (domItem, dmItem, channel) {
        ...
        dom.style.animation = 'barrage-run 12s linear infinite';
        // 弹幕全部显示之后 才能开始下一条弹幕
      ...
      shootTopDanmu (dmItem, channel) {
        ...
        dom.style.animation = 'barrage-fade 6s infinite';
      },
      // 获取空闲通道中空闲的dom
